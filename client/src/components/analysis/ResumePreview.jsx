...
function ResumePreview({ file }) {
  ...
  if (file instanceof File) {
    ...
    pdfUrl = file.filePath.startsWith("http")
      ? file.filePath
      : `${BACKEND_URL}${file.filePath}`;
  }
    ...
    >
      ...
      {!file ? (
        ...
        <>
          ...
          <div className="mt-6 max-h-[75vh] overflow-auto rounded-2xl border border-slate-200 dark:border-slate-700 bg-slate-100 dark:bg-slate-950 p-4 flex justify-center">
            <Document
              file={pdfUrl}
              ...
              loading={<p className="text-slate-500">Loading Resume...</p>}
